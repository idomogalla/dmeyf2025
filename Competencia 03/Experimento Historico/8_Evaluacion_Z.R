...
tryCatch(
  {
    ...
    if (PARAM$eval_ensamble$APO == TRUE) {
      ...
      dfuture_apo <- dataset[
        foto_mes %in% PARAM$eval_ensamble$mes_testing,
      ...
      for (vapo in seq(PARAM$eval_ensamble$iter)) {
        ...
        log_info(paste0(
          "--- Procesando Meta-Modelo APO: ", vapo,
      ...
      log_info(paste0(
        "Selección Final (APO): Meta-Modelo ", vmodelo,
      ...
      archivo_pseudo_kaggle <- file.path(dir_kaggle, paste0(
        "KA_APO_FINAL_",
