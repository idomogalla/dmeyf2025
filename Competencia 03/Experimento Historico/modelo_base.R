...
PARAM$hipeparametertuning$ksemillerio <- 10L
...
PARAM$train_final$APO <- FALSE # Realizo la comparativa con APO
PARAM$train_final$iter <- 10
PARAM$train_final$ksemillerio <- 5
