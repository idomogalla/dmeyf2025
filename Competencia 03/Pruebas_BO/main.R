...
PARAM$experimento <- "combinado_01"
...
source_con_log(file.path(home_dir, "11_Evaluacion_APO.R"), "11_Evaluacion_APO")
source_con_log(file.path(home_dir, "12_Modelo_Final.R"), "12_Modelo_Final")
