...
# Agrego los lags
log_info(paste0("Creando lags para los valores: ", paste(PARAM$FE_hist$lags$lag_values, collapse = ", ")))
if (PARAM$FE_hist$lags$run) {
  ...
  log_info(paste0("Creando delta lags para los valores: ", paste(PARAM$FE_hist$lags$lag_values, collapse = ", ")))
  for (i in PARAM$FE_hist$lags$lag_values) {
